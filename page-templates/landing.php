    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mission section">
                <h1 class="heading">
					<?php echo esc_html(get_theme_mod( "cust_services_heading")); ?>
                </h1>
                <?php if ( get_theme_mod('cust_services_display_subheading',1) ) {
                    ?>
                    <p class="subheading">
                        <?php echo esc_html(get_theme_mod( "cust_services_subheading")); ?>
                    </p>
                    <?php
                } ?>
               
                <div class="row sub-section">
                    <div class="<?php echo esc_attr( get_theme_mod('cust_services_column') ); ?>">
                        <div class="service">
